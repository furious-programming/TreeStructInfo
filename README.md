...
Latest API release: [TreeStructInfo 2.0 beta 5](https://github.com/furious-programming/TreeStructInfo/releases/tag/v2.0.0-beta.5)
...
- [**C++**](https://github.com/spartanPAGE/spartsi) - [here](https://github.com/spartanPAGE/spartsi) you can track the formation process of Patryk Wertka's TSI api implementation
