...
- [Text files syntax](#text-files-syntax)
- [Identifiers](#identifiers)
- [Frame of tree](#frame-of-tree)
- [Basic tree elements](#basic-tree-elements)
...
- [Referenced elements](#referenced-elements)
	- [Referenced attributes](#referenced-attributes)
	- [Referenced child nodes](#referenced-child-nodes)
	- [The order of referenced elements definitions](#the-order-of-referenced-elements-definitions)
- [Comments](#comments)
	- [Tree comment](#tree-comment)
	- [Attributes comments](#attributes-comments)
	- [Child nodes comments](#child-nodes-comments)
- [Binary form](#binary-form)
	- [Data types](#data-types)
	- [Static data](#static-data)
	- [Dynamic data](#dynamic-data)
- [Bindings](#bindings)
- [TreeStructInfo project support](#treestructinfo-project-support)
